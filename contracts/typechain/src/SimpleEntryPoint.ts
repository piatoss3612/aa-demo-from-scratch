...
export interface SimpleEntryPointInterface extends utils.Interface {
  functions: {
    ...
    "getSenderCreator()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getSenderCreator",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SimpleEntryPoint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleEntryPointInterface;
  ...
  functions: {
    ...
    getSenderCreator(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getSenderCreator(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getSenderCreator(overrides?: CallOverrides): Promise<PopulatedTransaction>;
