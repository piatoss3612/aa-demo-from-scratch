...
export interface SimpleAccountV2Interface extends utils.Interface {
  functions: {
...
export interface SimpleAccountV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleAccountV2Interface;
